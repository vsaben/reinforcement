...
**Ex. 1.5**:
a. More informed Q initialisation.
b. Play different sub-games (and amalgamate updates) that emanate from a particular state.
c. Tic-Tac-Toe Problem: Deterministic algorithm based on player moves.  
